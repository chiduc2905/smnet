"""Common selective state-space utilities for episodic few-shot models."""
...
class SelectiveStateSpaceCell(nn.Module):
    ...
    This is a lightweight Mamba-style selective scan cell tailored to the short
    sequences that arise in few-shot learning episodes.
    """
